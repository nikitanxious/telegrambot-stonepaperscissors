...
public class Bot {
    ...
    private void process(Update update) {
        ...
        if (message != null && message.viaBot() != null && message.viaBot().username().equals("@childgame_bot")) {
            ...
            InlineQueryResultArticle pipka = buildInlineButton("stone ", "\uD83D\uDD95 Камень", "0");
    ...
    private InlineQueryResultArticle buildInlineButton(String id, String title, String callbackData) {
        return new InlineQueryResultArticle(id, title, "Наша битва будет легендарной")
                .replyMarkup(
                        new InlineKeyboardMarkup(
